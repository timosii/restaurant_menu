...
async def test_reading_submenus(ac: AsyncClient, get_menuid_for_submenu_test):
    global test_menu_id
...
async def test_updating_submenu(ac: AsyncClient, get_updated_submenu):
...
async def test_reading_missing_submenu(ac: AsyncClient):
    response = await ac.get(f'{prefix}/{test_menu_id}/submenus/'
                            f'{test_submenu_id}')
